...
- fix: keep a guest's disks when the exporter publishes them as 0

## 0.3.185 - 2026-09-26

- fix: follow the seapath_alloc rename of vm_pinning_profile

## 0.3.184 - 2026-09-24

- fix: say on a playbook's card what its launch will ask for

## 0.3.183 - 2026-09-24

- fix: keep the top bar's right half in place on a narrow window

## 0.3.182 - 2026-09-24

- fix: follow the seapath_alloc and seapath_webui role renames

## 0.3.181 - 2026-09-24

- fix: refuse a pinning profile with an unknown isolation
...
- feat: a Usage page with each machine's CPU, memory, disks and network

## 0.3.177 - 2026-09-23

- fix: stop showing a guest's disks as 0 B when a scrape fails

## 0.3.176 - 2026-09-23

- feat: show each guest's vCPUs, memory and disk size on the VMs page

## 0.3.175 - 2026-09-23

- fix: offer a guest's graphic console only when it has a VNC display

## 0.3.174 - 2026-09-22

- feat: choose a machine's CPU allocation strategy from the pool

## 0.3.173 - 2026-09-22

- feat: a guest's domain or profile change is one run, restart included

## 0.3.172 - 2026-09-22

- feat: a pinning profile is written without the VM deployment

## 0.3.171 - 2026-09-22

- fix: a standalone guest's serial console runs virsh console
- fix: ask only the cluster members for Pacemaker and Ceph
- feat: the top bar says the inventory's mode beside the node's
- feat: edit a standalone guest's domain and pinning profile

## 0.3.170 - 2026-09-21

- feat: a pinned guest has a colour of its own on the VMs page
...
- fix: a pattern that matches nothing reads as no entry
- fix: the Logs link on a guest row is the size of its buttons

## 0.3.166 - 2026-09-21

- fix: the version button shows its tick and hides its arrow
...
- fix: the version button says its two quiet states as a glyph

## 0.3.162 - 2026-09-20

- feat: read a machine through its collector when it has one

## 0.3.161 - 2026-09-20

- feat: read the whole journal, and the units an operator names

## 0.3.160 - 2026-09-20

- feat: read the journal of every machine from one page
...
- feat: check for a newer version when a session opens

## 0.3.156 - 2026-09-19

- fix: offer the graphic console from the domain XML Ceph holds
...
- docs: show the Updates page in the README

## 0.3.151 - 2026-09-19

- fix: keep a tag on the Updates page whole on one line
...
- fix: wrap a docstring line ruff refused

## 0.3.147 - 2026-09-18

- docs: record why the root of a member was never unmounted

## 0.3.146 - 2026-09-18

- docs: record why a member booted its previous kernel

## 0.3.145 - 2026-09-18

- fix: say before an update whether a machine has room for its snapshot

## 0.3.144 - 2026-09-18

- feat: check the machines for software updates, and update them

## 0.3.143 - 2026-09-18

- fix: measure a backup directory not created yet on the server

## 0.3.142 - 2026-09-18

- fix: open the backup connection details below the other cards

## 0.3.141 - 2026-09-18

- fix: read the backup server's room from df alone
...
- fix: list the pool's images through sh, the one command sudo allows

## 0.3.135 - 2026-09-18

- fix: measure the backup volume on a member, selected images only

## 0.3.134 - 2026-09-18

- feat: list the backups in a window, and restore from it

## 0.3.133 - 2026-09-18

- feat: say whether a full backup fits, on the staging and on the server

## 0.3.132 - 2026-09-18

- fix: hold the reading guard to its new wording in the tests

## 0.3.131 - 2026-09-18

- fix: keep the Backup page off the automatic reading
...
- fix: keep the scripts' own defaults out of the backup settings form

## 0.3.123 - 2026-09-17

- fix: say why the backup server's directory needs its trailing slash

## 0.3.122 - 2026-09-17

- fix: read /etc/backup-restore.conf, and measure the volume on demand

## 0.3.121 - 2026-09-17

- feat: port the backup_restore role onto a Backup tab

## 0.3.120 - 2026-09-17

- feat: offer the files a guest came from on its own row

## 0.3.119 - 2026-09-16

- feat: open a container's quadlet, and place one the cluster holds

## 0.3.118 - 2026-09-16

- feat: hide the VMs Creation column where it would be empty on every row

## 0.3.117 - 2026-09-16

- fix: wipe a run's seed copy before the record says the run ended

## 0.3.116 - 2026-09-16

- feat: keep a guest's root password out of the inventory entirely
- fix: drop the VMs column that read "left alone" on every row

## 0.3.115 - 2026-09-16

- docs: list what a root password has to be checked on a machine for
...
- test: wait for the run lock rather than for the record alone

## 0.3.111 - 2026-09-16

- feat: say a guest's placement in the colour of its node name

## 0.3.110 - 2026-09-15

- feat: open a guest's serial console with vm-mgr console

## 0.3.109 - 2026-09-15

- docs: say what the ansible account's sudo actually allows

## 0.3.108 - 2026-09-15

- feat: open the console on another machine or a guest of the inventory
...
- feat: ping the address a new VM is given before creating it

## 0.3.104 - 2026-09-14

- fix: the login page fits a phone screen

## 0.3.103 - 2026-09-14

- fix: the top bar wraps on a phone screen
...
- ci: the image builds beside the tests, from a layer cache

## 0.3.100 - 2026-09-14

- fix: the run window reads the page again once a deployment run forgot

## 0.3.99 - 2026-09-14

- feat: a deployment run forgets how it created a guest, and the row deletes its files

## 0.3.98 - 2026-09-14

- docs: the VMs image shows a seeded guest and Forget
...
- feat: the tab title names the machine and the page

## 0.3.95 - 2026-09-13

- feat: a declared VM installs packages and accepts its host key

## 0.3.94 - 2026-09-13

- fix: the host key scan reaches the guests again

## 0.3.93 - 2026-09-13

- feat: a disabled cluster guest can be deleted for good

## 0.3.92 - 2026-09-13

- fix: the conformance tab counts the machines that carry a finding

## 0.3.91 - 2026-09-13

- feat: a conformance answer can be ignored in this browser
...
- fix: a panel is drawn from what this browser last read, and says so

## 0.3.83 - 2026-09-12

- fix: a page asks each question once, and a reading asks the machines

## 0.3.82 - 2026-09-12

- fix: a navigation inside a release fetches the document and nothing else
