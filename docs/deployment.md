...
# answering on it.
podman pull docker.io/insatomcat/seapath-webui:0.3.0
...
| `seapath_webui_image` | no | `docker.io/insatomcat/seapath-webui:0.3.0` | Image reference, an exact tag. This is the variable [D23](decisions.md#d23) turns into the update lever: editing it in the inventory and applying is how the service replaces itself |
