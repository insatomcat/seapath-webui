...
| 5 | **List the backups** answers in a second or two and shows what check 1 and check 4 wrote, with the two dates the guest can be restored to | The one POSIX shell command against a real backup server's shell, over two real SSH hops | Pending |
